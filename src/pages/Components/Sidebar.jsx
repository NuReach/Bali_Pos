...
export default function Sidebar({route}) {
  ...
  return (
    <div className={showSidebarBoolean ?'  absolute  flex   bg-white lg:relative lg:flex flex-col gap-6  border-r min-h-screen shadow-lg' :'  hidden bg-white lg:relative lg:flex flex-col gap-6 w-36 border-r min-h-screen shadow-lg'}>
        <section className='flex flex-col gap-6 p-6'>
            ...
            }} className={route == "login" ? ' bg-yellow-700 text-white p-3 w-24 flex flex-col gap-1 rounded-lg justify-center items-center' : '  text-gray-700 p-3 w-24 flex flex-col gap-1 rounded-lg justify-center items-center'}>
